...
Select.propTypes = {
	...
	valueCloseAriaLabel: _propTypes2.default.string, // Aria label for close value - used for aria
	valueAriaLabel: _propTypes2.default.string, // Aria label for value - used for aria
	optionAriaLabel: _propTypes2.default.string
};
