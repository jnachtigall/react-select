...
var propTypes = {
	...
	keepMenuOpenWhileLoading: _propTypes2.default.bool, // keep dropdown open while waiting for loadOptions; defaults to false
...
var Async = function (_Component) {
	...
	_createClass(Async, [{
		...
		value: function loadOptions(inputValue) {
			...
			if (this._callback && !this.props.keepMenuOpenWhileLoading && !this.state.isLoading) {
				this.setState({
					isLoading: true
				});
			}
